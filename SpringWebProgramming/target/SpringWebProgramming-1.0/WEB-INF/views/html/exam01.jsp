...
<html>
    ...
    <body>
		...
		<h3>이미지태그</h3>
		<img src="<%=application.getContextPath() %>/resources/image/Tulips.jpg" alt="Tulips" height="300"/>
		<input type="image" src="<%=application.getContextPath() %>/resources/image/Tulips.jpg" height="300"/>
