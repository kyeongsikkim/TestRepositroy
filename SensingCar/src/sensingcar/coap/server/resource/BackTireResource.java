...
public class BackTireResource extends CoapResource {
	...
	public BackTireResource() throws Exception {
		...
		dcMotorLeft = new DCMotor(RaspiPin.GPIO_00, RaspiPin.GPIO_01, pca9685, PCA9685.PWM_O5);
		dcMotorRight = new DCMotor(RaspiPin.GPIO_02, RaspiPin.GPIO_03, pca9685, PCA9685.PWM_O4);
		forward();
	}
