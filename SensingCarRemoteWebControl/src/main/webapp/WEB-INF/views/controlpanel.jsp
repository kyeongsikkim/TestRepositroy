						...
						<div class="col-lg-3">
							<div style="background: linear-gradient(#737373, black); color: white; height:150px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center;">
									...
									<button type="button" class="btn btn-primary" onclick="fronttire('change', '115')">>></button>
								</div>
							</div> 
						</div>
						<div class="col-lg-5">
							<div style="background: linear-gradient(#737373, black); color: white; height:150px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center">현재 상태: <span id="backtireStatus">speed=${backtireSpeed},direction=${backtireDirection}</span></div>
								<br/>
								<div style="text-align: center;">
									<button type="button" class="btn btn-warning" onclick="backtire('change',${backtireSpeed}, 'forward',)" style="margin-bottom: 5px;">전진</button>
									<button type="button" class="btn btn-info" onclick="backtire('change',${backtireSpeed} ,'backward')" style="margin-bottom: 5px;">후진</button>
									<br/>
									<button  id="backtirespeed0" onclick="backtire('change','0',${backtireDirection})" style="color: black;">0</button>
									<button id="backtirespeed1" onclick="backtire('change', '1100',${backtireDirection})" style="color: black;">1</button>
									<button id="backtirespeed2" onclick="backtire('change', '1200',${backtireDirection})" style="color: black;">2</button>
									<button id="backtirespeed3" onclick="backtire('change', '1300',${backtireDirection})" style="color: black;">3</button>
									<button id="backtirespeed4" onclick="backtire('change', '1400',${backtireDirection})" style="color: black;">4</button>
									<button id="backtirespeed5" onclick="backtire('change', '1500',${backtireDirection})" style="color: black;">5</button>
									<button id="backtirespeed6" onclick="backtire('change', '1600',${backtireDirection})" style="color: black;">6</button>
									<button id="backtirespeed7" onclick="backtire('change', '1700',${backtireDirection})" style="color: black;">7</button>
									<button id="backtirespeed8" onclick="backtire('change', '1800',${backtireDirection})" style="color: black;">8</button>
									<button id="backtirespeed9" onclick="backtire('change', '1900',${backtireDirection})" style="color: black;">9</button>
									<button id="backtirespeed10" onclick="backtire('change', '2000',${backtireDirection})" style="color: black;">10</button>
								</div>                                      
							</div> 
						</div>
					</div>          
